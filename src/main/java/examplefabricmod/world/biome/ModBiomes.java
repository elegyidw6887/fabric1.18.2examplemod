...
public class ModBiomes {
    ...
    public static final RegistryKey<Biome> EXAMPLE_BIOME = RegistryKey.of(Registry.BIOME_KEY,
            new Identifier(ExampleFabricMod.MOD_ID, "example_biome"));


    public static void registerModBiomes() {

        Registry.register(BuiltinRegistries.BIOME, EXAMPLE_BIOME.getValue(), ExampleBiome.createExampleBiome());
